    ...
    <Dropdown :options="[
      ...
      <Button :variant="'ghost'" :class="{ 'active': isActive }" class="h-13" @click="isActive = !isActive">
        <template v-if="isCollapsed">
          ...
          <Avatar class="flex-shrink-0 rounded ml-[-2px]" :shape="'square'" image="/assets/v1portal/images/v1portal.svg" label="EY"
            size="xl" />
        ...
        <template v-else>
          <div style="margin-left:40px">
            <div class="flex-shrink-0 text-sm duration-300 ease-in-out mr-1 ml-0 w-auto opacity-100"
              ...
              <Avatar class="size-8 flex-shrink-0 rounded" image="/assets/v1portal/images/v1portal.svg" :shape="'square'"
            ...
            <div class="flex flex-1 flex-col text-left duration-300 ease-in-out ml-2 w-auto opacity-100"
              ...
              <p class="font-medium" style="margin-left:-15px">V1 Portal</p>
...
export default {
  ...
  setup() {
    ...
    const users = createResource({
      url: 'v1portal.v1portal.v1portal.get_username',
      cache: ['true']
    });
    users.fetch()
    ...
    const dynamicsApp = createResource({
      url: 'v1portal.v1portal.api.api.get_navbar_routes',
      cache: ['route', 'title'],
      auto: true
    });
    dynamicsApp.fetch()
