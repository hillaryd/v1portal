  ...
  <div class="max-h-screen flex items-center justify-center">
    <Card class="w-full max-w-md mt-4 border-none shadow-none">
      <div class="flex justify-center p-5">
        <Avatar :shape="'square'" image="/assets/v1portal/images/v1portal.svg" label="EY" size="2xl" />       
      </div>     
      <h1 class="text-center text-3xl font-semibold text-gray-900 mb-4">Login to V1 Portal</h1>
